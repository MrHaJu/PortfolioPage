<?php
class Default_action_NewContentElement_Wizard_881c8d2b1408e5ce extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<typo3-backend-new-content-element-wizard categories="';

$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('categoriesJson')]);

<?php
class layout_Default_html_be3e097aa061492b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '
';
// Rendering ViewHelper Praetorius\ViteAssetCollector\ViewHelpers\Asset\ViteViewHelper
...
'priority' => false,
'useNonce' => false,
'entry' => 'EXT:mrhaju_sidepackage/Resources/Private/Frontend/main.entry.js',
];

$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Praetorius\ViteAssetCollector\ViewHelpers\Asset\ViteViewHelper::renderStatic($arguments1, $renderChildrenClosure2, $renderingContext)]);

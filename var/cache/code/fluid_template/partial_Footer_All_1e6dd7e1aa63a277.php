<?php
class partial_Footer_All_1e6dd7e1aa63a277 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array2 = [
'0' => $renderingContext->getVariableProvider()->getByPath('data.linkToTop'),
];

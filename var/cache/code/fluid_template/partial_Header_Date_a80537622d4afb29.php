<?php
class partial_Header_Date_a80537622d4afb29 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
'locale' => NULL,
'base' => NULL,
'format' => $renderingContext->getVariableProvider()->getByPath('format'),
];

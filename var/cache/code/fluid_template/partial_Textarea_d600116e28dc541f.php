<?php
class partial_Textarea_d600116e28dc541f extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
'rows' => $renderingContext->getVariableProvider()->getByPath('element.properties.rows'),
'cols' => $renderingContext->getVariableProvider()->getByPath('element.properties.cols'),
...
$output27 .= TYPO3\CMS\Fluid\ViewHelpers\Form\TextareaViewHelper::renderStatic($arguments28, $renderChildrenClosure29, $renderingContext);
